...
class MyData(data.Dataset):
    def __init__(self, data_dir=r'data/ref',
        ...
        ### TODO 消融实验，记得删
        if num_k == -1:
            self.data_dir = os.path.join(data_dir, base_model, self.dataset_name, 'K_random')
        elif num_k == 10:
            self.data_dir = os.path.join(data_dir, base_model, self.dataset_name, 'K_10')
        elif num_k == 100:
            self.data_dir = os.path.join(data_dir, base_model, self.dataset_name, 'K_100')
        else:
