...
parser.add_argument('--h5_root', type=str, default='path/to/h5_files')
parser.add_argument('--pt_path', type=str, default='path/to/pt_files', help='path to features')
parser.add_argument('--wsi_root', type=str, default='path/to/wsis')
parser.add_argument('--heatmap_score_root', type=str, default='heatmap/BASE_MODEL/PROJECT_ID/MODEL_NAME', help='path to heatmap score')
